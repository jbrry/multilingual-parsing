...
@DatasetReader.register("universal_dependencies_tbemb")
class UniversalDependenciesTbembDatasetReader(DatasetReader):
    """
    ...
    def text_to_instance(self,  # type: ignore
        ...
        Returns
        -------
        An instance containing words, upos tags, treebank ids, dependency head tags and head
